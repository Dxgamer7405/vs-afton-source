...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Lightning Timer', "Value 1: Change the lightning timers beat\n(only for the scott level)"],
		['FG Flash', "light the screen up\nvalues are the same as add camera zoom\n(only for the scott level)"],
		['Shadow Bonnie BG', "Value 1: Changes if the background is visible (0 - Off, 1 - On)\n(only for the shadow bonnie level)"],
		['Shadow Bonnie Error', ""],
		['Shadow Bonnie Not Error', ""],
		['Afton BG Darker', "Value 1: Changes value of darkness (0 - Off, 1 - + 0.1)\n(only for the follow-me level)"],
		['Midnight Black', "Value 1: Changes value of darkness (0 - 0.7, 1 - + 0.1)\n(only for the Midnight level)"],
		['Midnight Black Finale', "Value 1: Changes value of darkness (0 - 1)\n(only for the Mmidnight level)"],
		['Fade Character', "Value 1: Character (0 - Dad, 1 - BF, 2 - GF)"],
		['Shadow Bonnie Glitch', "Only works on the Umbra Stage"],
		['Phantom Puppet', "(0 - appear, 1 - fuck off)\n(only works on the Salvage level)"],
		['Phantom Chica', "(1 - on)\n(only works on the Salvage level)"],
		['Phantom BB', "(1 - on)\n(only works on the Salvage level)"],
		['6am chime', "6am"],
		['new night', "12am"],
		['start salvage', "12am"],
		['beep','bep'],
		['blood lmao', " (0 - Off, 1 - On)\n(only for the You Can't level)"],
		['Matpat-to-Pixel-First', "ha"],
		['Matpat-to-Pixel', "ha"],
		['Matpat-to-Normal', "ha"],
		['GT-Logo-Anim', "ha"],
		['Matpat-Zoom-Out', "ha"],
		['scary', "a"],
		['ip grabber', "not an actual ip grabber"],
		['Springjump', "aaaaaaaaa"]
	];
